...
public abstract class TimeUtils {
	 ...
	 * 日期格式4（yyyyMMdd）
	 */
	private static SimpleDateFormat mSimpleDateFormat_4 = new SimpleDateFormat("yyyyMMdd");


	/**
	 * 日期格式4（yyyyMMddHHmmss）
	 */
	private static SimpleDateFormat mSimpleDateFormat_5 = new SimpleDateFormat("yyyyMMddHHmmss");
	...
	/**
	 * 获取当前时间，精确到毫秒（格式：yyyyMMdd）
	 * @return 当前时间字符串（格式：yyyyMMdd）
	 */
	public static String getCurrentTime_4(){
		String currentTime=null;
		try {
			currentTime=mSimpleDateFormat_4.format(new Date());
		} catch (Exception e) {
	...
	/**
	 * 获取当前时间，精确到毫秒（格式：yyyyMMddHHmmss）
	 * @return 当前时间字符串（格式：yyyyMMddHHmmss）
	 */
	public static String getCurrentTime_5(){
		String currentTime=null;
		try {
			currentTime=mSimpleDateFormat_5.format(new Date());
		} catch (Exception e) {
